...
class ReceivesVoltageWaveform_ProvidesResponse_MultipleLocations(sciunit.Capability):
    """Indicates that current can be injected into the model as
    a square pulse. And records at multiple locations."""

    def inject_voltage_waveform_respons_multiple_loc(self, soma_AP1_waveform, delay, duration_waveform, section_stim, loc_stim, dend_locations):
        """
    ...
    def get_voltage_waveform_multiple_vm(self, soma_AP1_waveform, delay, duration_waveform, section_stim, loc_stim, dend_locations):
        """
        ...
        t, v_stim, v = self.inject_voltage_waveform_respons_multiple_loc(soma_AP1_waveform, delay, duration_waveform, section_stim, loc_stim, dend_locations)
        return t, v_stim, v
